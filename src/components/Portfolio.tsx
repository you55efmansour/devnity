...
const Portfolio: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('portfolio-filter', handler);
    return () => window.removeEventListener('portfolio-filter', handler);
  }, []);
  ...
  return (
    <section id="portfolio" className={`py-20 ${theme === 'dark' ? 'bg-gradient-to-b from-black to-gray-900' : 'bg-gradient-to-b from-white to-gray-100'}`}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-block">
            <div className="flex items-center justify-center">
              <div className="h-1 w-12 bg-blue-600 mr-4"></div>
              <p className="text-blue-500 font-medium">OUR PORTFOLIO</p>
          ...
          <p className={`${theme === 'dark' ? 'text-white ' : 'text-black '} max-w-2xl mx-auto mt-4`}>
            Explore our diverse portfolio of innovative solutions across multiple platforms and industries.
          </p>
            ...
            >
              ...
              <div className="relative z-10 overflow-hidden rounded-xl bg-gray-900 border border-gray-800 hover:border-blue-600 transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <a 
                    href="#" 
                    className="inline-block mt-4 text-blue-500 hover:text-blue-400 font-medium transition-colors duration-300"
                  >
                    {/* View Details */}
                  </a>
                </div>
